CMSIS 2.0 DSP Library (Cortex-M4, without floating point unit)
==============================================================

This project provides a pre-built version of ARM's CMSIS v2.0
DSP Library. This library is suitable for use on a Cortex-M4
which does not implement the optional floating point unit, or
by a application project which has been created with support 
for the floating point unit disabled.
